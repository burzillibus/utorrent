...
LABEL maintainer="vincenzo.man@gmail.com"
...
RUN apt-get update; apt-get install -y nano wget; apt-get install -y libssl1.0.0 libssl-dev; wget https://download-hr.utorrent.com/track/beta/endpoint/utserver/os/linux-x64-ubuntu-13-04 -O utserver.tar.gz; tar xvf utserver.tar.gz -C /opt/; \
